    ...
    <div className="drag-region flex items-center justify-between h-9 bg-background border-b border-border shrink-0 select-none">
      ...
      <div className="no-drag flex h-full">
        <button
          ...
          className="h-full px-3.5 hover:bg-black/5 transition-colors flex items-center justify-center cursor-pointer"
        >
        ...
        <button
          onClick={handleClose}
          className="h-full px-3.5 hover:bg-red-600 transition-colors flex items-center justify-center cursor-pointer"
        >
